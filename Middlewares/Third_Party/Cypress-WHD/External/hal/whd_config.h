#ifndef _WHD_CONFIG_H
#define _WHD_CONFIG_H
...
#endif /* WIFI_USE_THREADX */

#if (defined(WIFI_USE_NETXDUO) && (WIFI_USE_NETXDUO == 1))
...
#define WHD_THREAD_STACK_SIZE   (7*1024)
#define WHD_THREAD_PRIORITY     CY_RTOS_PRIORITY_NORMAL
