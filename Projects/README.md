...
> [!NOTE]
> 
> The `Ux_Device_Audio2.0_PlayBack` application does not functionally depend on `STM32_Audio` middleware; however, `STM32_Audio` is required for compilation due to BSP dependencies.
