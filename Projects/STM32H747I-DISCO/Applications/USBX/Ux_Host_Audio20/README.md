...
This application provides an example of Azure RTOS USBX stack usage. It shows how to develop AUDIO" able to enumerate and communicates with a device audio speaker 1.0/2.0.
...
When an usb speaker is plugged to STM32H747-DK board, a Message will be displayed on the uart HyperTerminal showing  the Vendor ID and the Product ID of the attached device.
