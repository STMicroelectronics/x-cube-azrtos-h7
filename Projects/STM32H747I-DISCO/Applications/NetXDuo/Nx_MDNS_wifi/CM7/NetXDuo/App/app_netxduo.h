...
#define NETX_IP_THREAD_STACK_SIZE            4 * DEFAULT_MEMORY_SIZE
#define NETX_IP_THREAD_PRIORITY              CY_RTOS_PRIORITY_NORMAL

#define APP_MDNS_THREAD_STACK_SIZE           8 * DEFAULT_MEMORY_SIZE
#define APP_MDNS_THREAD_PRIORITY             CY_RTOS_PRIORITY_BELOWNORMAL

#define NETX_MDNS_THREAD_STACK_SIZE          4 * DEFAULT_MEMORY_SIZE
#define NETX_MDNS_THREAD_PRIORITY            CY_RTOS_PRIORITY_BELOWNORMAL
