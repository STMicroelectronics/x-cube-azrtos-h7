...
#define NX_DHCP_THREAD_PRIORITY         CY_RTOS_PRIORITY_NORMAL
...
#define NX_WEB_HTTP_SERVER_PRIORITY       CY_RTOS_PRIORITY_NORMAL
...
#define NX_WEB_HTTP_NO_FILEX
#define NX_IPERF_THREAD_PRIORITY                CY_RTOS_PRIORITY_NORMAL
/* USER CODE END 2 */
