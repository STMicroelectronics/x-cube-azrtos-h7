...
/* Binary data for the TLS Client X.509 trusted root CA certificate, ASN.1 DERencoded.
 * A trusted certificate must be provided for TLS Client applications (unless X.509 authentication is disabled) or
 * TLS will treat all certificates as untrusted and the handshake will fail.
 */
